...
export default class HamburgerButton extends Component<HamburgerButtonProps, HamburgerButtonState> {
            ...
            >
                ...
                {({ x, y }) =>
                    ...
                    <line 
                        ...
                        x1="14" y1="52" x2="178" y2="52" 
                    />
                    <line 
                        /*transform={`translate(${x * 12}, ${x * 7}) rotate(${x * -45}, 7, 70)`} */
                        x1="14" y1="140" x2="178" y2="140" 
                    />
                    <line 
                        /*transform={`translate(${x * -96})`} */
                        /*opacity={y} */
                        x1="14" y1="96" x2="178" y2="96"
                    />
                    </g>
                }
                </Motion>
